...
import PriceEditor, { PricingData } from "./PriceEditor";
...
const PricingTable = () => {
  ...
  const handleSavePrices = (newPrices: PricingData) => {
      ...
      <div className="container mx-auto">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <div className="flex justify-center items-center space-x-4 mt-8">
            <div className="inline-flex items-center justify-center p-1 rounded-full bg-gray-100 animate-fade-in stagger-2">
              <button
            ...
            {customPrices.isAdmin && (
              <Button
                variant="outline"
                className="text-sm border-dashed border-gray-300 hover:border-just-orange"
                ...
                <table className="pricing-table">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>€0</td>
                      <td>{customPrices.light}</td>
                      <td className="featured-column">{customPrices.standard}</td>
                      <td>{customPrices.premium}</td>
                    </tr>
                    <tr>
        ...
        {!customPrices.isAdmin && (
          <div className="mt-8 text-center">
            <button 
              onClick={() => setCustomPrices(prev => ({ ...prev, isAdmin: true }))}
